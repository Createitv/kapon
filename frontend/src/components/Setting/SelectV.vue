<template>
    <el-select v-model="value" class="m-2" placeholder="打字检索" size="large" filterable autocomplete
               @click="visibleChange">
        <el-option v-for="item in options.slice(0, showOptionsCount)" :key="item.value"
